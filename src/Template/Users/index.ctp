    ...
    <table cellpadding="0" cellspacing="0" class="table table-hover table-responsive table-striped">
        ...
        <tbody>
            ...
            ['accuracy'=> ['day'=>'day']]);?>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $user->id],['class'=>'btn','style'=>'background-color:teal;color:white']) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $user->id],['class'=>'btn','style'=>'background-color:teal;color:white'])?>
